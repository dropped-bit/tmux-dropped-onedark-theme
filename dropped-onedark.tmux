...
main() {
  ...
  local show_window
  readonly show_window="#[fg=$thm_pink,bg=$thm_bg,nobold,nounderscore,noitalics]$right_separator#[fg=$thm_bg,bg=$thm_bg,nobold,nounderscore,noitalics]  #[fg=$thm_pink,bg=$thm_bg] #W #{?client_prefix,#[fg=$thm_red]"
